...
public class SimpleBDDTest extends TestWithFormulaContext {
    ...
    public void testTrue(final FormulaContext _c) {
        ...
        Assertions.assertThat(bdd.underlyingKernel().factory()).isSameAs(_c.f);
        ...
        Assertions.assertThat(bdd.toLngBdd()).isEqualTo(BDDConstant.getVerumNode(_c.f));
    }
    ...
    public void testFalse(final FormulaContext _c) {
        ...
        Assertions.assertThat(bdd.underlyingKernel()).isSameAs(kernel);
        Assertions.assertThat(bdd.underlyingKernel().factory()).isSameAs(_c.f);
        assertThat(bdd.enumerateAllModels()).isEmpty();
        assertThat(bdd.numberOfClausesCNF()).isEqualTo(BigInteger.ONE);
        Assertions.assertThat(bdd.toLngBdd()).isEqualTo(BDDConstant.getFalsumNode(_c.f));
    }
    ...
    public void testPositiveLiteral(final FormulaContext _c) {
        ...
        assertThat(bdd.numberOfClausesCNF()).isEqualTo(BigInteger.ONE);
        Assertions.assertThat(bdd.toLngBdd().toString()).isEqualTo("<A | low=<$false> high=<$true>>");
    }
    ...
    public void testNegativeLiteral(final FormulaContext _c) {
        ...
        assertThat(bdd.numberOfClausesCNF()).isEqualTo(BigInteger.ONE);
        Assertions.assertThat(bdd.toLngBdd().toString()).isEqualTo("<A | low=<$true> high=<$false>>");
    }
