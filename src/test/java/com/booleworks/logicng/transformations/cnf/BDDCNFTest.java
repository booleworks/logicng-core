...
public class BDDCNFTest extends TestWithFormulaContext {
    ...
    public void testNAryOperators(final FormulaContext _c) throws ParserException {
        ...
        Assertions.assertThat(TestUtil.equivalentModels(f1, f1.transform(bddcnf), f1.variables(_c.f))).isTrue();
        assertThat(f2.transform(bddcnf).isCNF(_c.f)).isTrue();
        Assertions.assertThat(TestUtil.equivalentModels(f2, f2.transform(bddcnf), f2.variables(_c.f))).isTrue();
        assertThat(f3.transform(bddcnf).isCNF(_c.f)).isTrue();
        Assertions.assertThat(TestUtil.equivalentModels(f3, f3.transform(bddcnf), f3.variables(_c.f))).isTrue();
    }
    ...
    public void testNot(final FormulaContext _c) throws ParserException {
        ...
        Assertions.assertThat(_c.p.parse("~a").transform(bddcnf)).isEqualTo(_c.p.parse("~a"));
        Assertions.assertThat(_c.p.parse("~~a").transform(bddcnf)).isEqualTo(_c.p.parse("a"));
        Assertions.assertThat(_c.p.parse("~(a => b)").transform(bddcnf)).isEqualTo(_c.p.parse("a & ~b"));
        ...
        Assertions.assertThat(TestUtil.equivalentModels(f4, f4.transform(bddcnf), f4.variables(_c.f))).isTrue();
        assertThat(f5.transform(bddcnf).isCNF(_c.f)).isTrue();
        Assertions.assertThat(TestUtil.equivalentModels(f5, f5.transform(bddcnf), f5.variables(_c.f))).isTrue();
        assertThat(f5.transform(bddcnf).isCNF(_c.f)).isTrue();
        Assertions.assertThat(TestUtil.equivalentModels(f5, f5.transform(bddcnf), f5.variables(_c.f))).isTrue();
    }
