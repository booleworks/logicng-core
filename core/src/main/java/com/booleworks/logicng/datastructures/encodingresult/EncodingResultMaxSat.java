 ...
 */
public final class EncodingResultMaxSat implements EncodingResult {
    private final MaxSatSolver solver;
    private final MaxSat underlyingSolver;
    ...
    public Variable newVariable(final String auxType) {
        ...
        final Variable v = new EncodingAuxiliaryVariable(name, false);
