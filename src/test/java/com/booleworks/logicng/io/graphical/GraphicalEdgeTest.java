...
public class GraphicalEdgeTest {
    ...
    public void testOnlyColor() {
        final GraphicalEdge edge = new GraphicalEdge(n1, n2, GraphicalEdgeStyle.style(null, GraphicalColor.BLACK));
        grDirected.addEdge(edge);
        grUndirected.addEdge(edge);
        ...
        assertThat(grUndirected.writeString(dotWriter))
    ...
    @Test
    public void testAll() {
        final GraphicalEdge edge = new GraphicalEdge(n1, n2, GraphicalEdgeStyle.bold(GraphicalColor.BLACK));
        grDirected.addEdge(edge);
        grUndirected.addEdge(edge);

        assertThat(grDirected.writeString(dotWriter))
