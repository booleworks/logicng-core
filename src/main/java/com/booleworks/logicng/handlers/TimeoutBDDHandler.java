...
public class TimeoutBDDHandler extends TimeoutHandler implements BDDHandler {
     ...
     * </ul>
     * Note that it might take a few milliseconds more until the build process
     * is actually canceled, since the handler depends on the BDD factory's call
     * to {@link BDDKernel#addRef(int, BDDHandler)}.
