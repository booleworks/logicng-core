...
public class FormulaFactoryWithoutContradictionCheckTest {
    ...
    public void testNormalforms() {
        ...
        assertThat(this.tautology.transform(new DNFFactorization(f))).isEqualTo(this.tautology);
        assertThat(this.contradiction.transform(new DNFFactorization(f))).isEqualTo(this.contradiction);
    }
