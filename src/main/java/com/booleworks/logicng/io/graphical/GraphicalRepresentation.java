...
import com.booleworks.logicng.io.graphical.generators.BddGraphicalGenerator;
import com.booleworks.logicng.io.graphical.generators.FormulaAstGraphicalGenerator;
import com.booleworks.logicng.io.graphical.generators.FormulaDagGraphicalGenerator;
import com.booleworks.logicng.io.graphical.generators.GraphGraphicalGenerator;
...
/**
 * A graphical representation of a formula, BDD, or graph. The representation is
 * a graph and holds the nodes and edges for the graph, a background color (only
 * used for DOT output), a flag whether all terminal nodes should be on the same
 * level (only used for DOT output) and a flag whether the graph is directed or
 * undirected.
 * <p>
 * This is a generic representation which can be generated by one of the
 * following generators:
 * <ul>
 * <li>Formula AST: {@link FormulaAstGraphicalGenerator}
 * <li>Formula DAG: {@link FormulaDagGraphicalGenerator}
 * <li>BDD: {@link BddGraphicalGenerator}
 * <li>Graph: {@link GraphGraphicalGenerator}
 * </ul>
 * This representation can then be written in different output formats. LogicNG
...
public class GraphicalRepresentation {
    ...
    /**
     * Generates a new graphical representation with the given values and no
     * background.
     * @param alignTerminals a flag whether all terminal nodes should be aligned
     *                       on the same level (only possible in DOT output)
     * @param directed       a flag whether the graph of the representation is
     ...
     */
    public GraphicalRepresentation(final boolean alignTerminals, final boolean directed,
                                   final GraphicalColor background) {
     ...
     */
    public GraphicalRepresentation(final boolean alignTerminals, final boolean directed,
                                   final GraphicalColor background, final List<GraphicalNode> nodes,
    ...
    /**
     * Writes this representation to a file with the given file name using the
     * given writer.
    ...
    /**
     * Returns whether all terminal nodes should be aligned on the same level
     * (only possible in DOT output).
     * @return {@code true} if all terminal nodes should be aligned on the same
     *         level (only possible in DOT output), otherwise {@code false}
     */
    ...
    /**
     * Returns whether the graph of the representation is directed or
     * undirected.
     * @return {@code true} if the graph of the representation is directed,
