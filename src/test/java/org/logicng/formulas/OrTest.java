...
public class OrTest extends TestWithFormulaContext {
    ...
    public void testLiterals(final FormulaContext _c) {
        assertThat(_c.or2.literals().size()).isEqualTo(2);
        SortedSet<Literal> lits = new TreeSet<>(Arrays.asList(_c.nx, _c.ny));
        assertThat(_c.or2.literals()).isEqualTo(lits);
    ...
    public void testNumberOfAtoms(final FormulaContext _c) {
        ...
        assertThat(_c.or2.numberOfAtoms()).isEqualTo(2);
        assertThat(_c.or3.numberOfAtoms()).isEqualTo(4);
        assertThat(_c.or3.numberOfAtoms()).isEqualTo(4);
    }
    ...
    public void testNumberOfNodes(final FormulaContext _c) {
        assertThat(_c.or1.numberOfNodes()).isEqualTo(3);
        assertThat(_c.or2.numberOfNodes()).isEqualTo(3);
        assertThat(_c.or3.numberOfNodes()).isEqualTo(7);
        assertThat(_c.or3.numberOfNodes()).isEqualTo(7);
    }
    ...
    public void testIsNNF(final FormulaContext _c) {
        assertThat(_c.or1.isNNF()).isTrue();
        assertThat(_c.or2.isNNF()).isTrue();
        assertThat(_c.or3.isNNF()).isTrue();
    }

    @ParameterizedTest
    @MethodSource("contexts")
    public void testIsDNF(final FormulaContext _c) {
        assertThat(_c.or1.isDNF()).isTrue();
        assertThat(_c.or2.isDNF()).isTrue();
        assertThat(_c.or3.isDNF()).isTrue();
    }

    @ParameterizedTest
    @MethodSource("contexts")
    public void testIsCNF(final FormulaContext _c) {
        assertThat(_c.or1.isCNF()).isTrue();
        assertThat(_c.or2.isCNF()).isTrue();
        assertThat(_c.or3.isCNF()).isFalse();
    }
}
