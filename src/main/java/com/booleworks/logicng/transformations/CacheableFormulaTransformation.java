 ...
 * transformation.  Formulas from a caching formula factory provide their cache via the factory,
 * formulas from a non-caching formula factory can be given their own cache per transformation.
 * A cacheable formula transformation with a provided cache is not thread-safe.
 * @version 3.0.0
 * @since 3.0.0
 */
