...
public class PbSolvingTest implements LogicNGTest {
    ...
    public PbSolvingTest() {
        ...
        configs = new EncoderConfig[10];
        configs[0] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.SWC).build();
        configs[1] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.BINARY_MERGE).binaryMergeUseGAC(true)
                .binaryMergeNoSupportForSingleBit(true).binaryMergeUseWatchDog(true).build();
        configs[2] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.BINARY_MERGE).binaryMergeUseGAC(true)
                .binaryMergeNoSupportForSingleBit(true).binaryMergeUseWatchDog(false).build();
        configs[3] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.BINARY_MERGE).binaryMergeUseGAC(true)
                .binaryMergeNoSupportForSingleBit(false).binaryMergeUseWatchDog(true).build();
        configs[4] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.BINARY_MERGE).binaryMergeUseGAC(true)
                .binaryMergeNoSupportForSingleBit(false).binaryMergeUseWatchDog(false).build();
        configs[5] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.BINARY_MERGE).binaryMergeUseGAC(false)
                .binaryMergeNoSupportForSingleBit(true).binaryMergeUseWatchDog(true).build();
        configs[6] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.BINARY_MERGE).binaryMergeUseGAC(false)
                .binaryMergeNoSupportForSingleBit(true).binaryMergeUseWatchDog(false).build();
        configs[7] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.BINARY_MERGE).binaryMergeUseGAC(false)
                .binaryMergeNoSupportForSingleBit(false).binaryMergeUseWatchDog(true).build();
        configs[8] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.BINARY_MERGE).binaryMergeUseGAC(false)
                .binaryMergeNoSupportForSingleBit(false).binaryMergeUseWatchDog(false).build();
        configs[9] = EncoderConfig.builder().pbEncoding(EncoderConfig.PB_ENCODER.ADDER_NETWORKS).build();
    }
